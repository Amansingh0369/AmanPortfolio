...
const Icons = {
    ...
    openai: () => (
        <img src="src/assets/images/profilepic.png" alt="React Logo" width="150" height="150" />

    ),
    react: () => (
        <img src="src/assets/images/react.svg" alt="React Logo" width="150" height="150" />
    ),
    Js: () => (
        <img src="src/assets/images/Javascript.png" alt="React Logo" width="150" height="150" />
    ),
    googleDocs: () => (
        <svg
            width="47px"
